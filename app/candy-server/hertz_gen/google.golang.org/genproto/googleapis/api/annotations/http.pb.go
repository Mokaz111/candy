...
type Http struct {
	...
	Rules []*HttpRule `protobuf:"bytes,1,rep,name=rules,proto3" json:"rules,omitempty" form:"rules" query:"rules"`
	...
	// segment matches.
	FullyDecodeReservedExpansion bool `protobuf:"varint,2,opt,name=fully_decode_reserved_expansion,json=fullyDecodeReservedExpansion,proto3" json:"fully_decode_reserved_expansion,omitempty" form:"fully_decode_reserved_expansion" query:"fully_decode_reserved_expansion"`
}
...
type HttpRule struct {
	...
	Selector string `protobuf:"bytes,1,opt,name=selector,proto3" json:"selector,omitempty" form:"selector" query:"selector"`
	...
	// message type.
	Body string `protobuf:"bytes,7,opt,name=body,proto3" json:"body,omitempty" form:"body" query:"body"`
	...
	// message type.
	ResponseBody string `protobuf:"bytes,12,opt,name=response_body,json=responseBody,proto3" json:"response_body,omitempty" form:"response_body" query:"response_body"`
	// Additional HTTP bindings for the selector. Nested bindings must
	// not contain an `additional_bindings` field themselves (that is,
	// the nesting may only be one level deep).
	AdditionalBindings []*HttpRule `protobuf:"bytes,11,rep,name=additional_bindings,json=additionalBindings,proto3" json:"additional_bindings,omitempty" form:"additional_bindings" query:"additional_bindings"`
}
...
type CustomHttpPattern struct {
	...
	Kind string `protobuf:"bytes,1,opt,name=kind,proto3" json:"kind,omitempty" form:"kind" query:"kind"`
...
var file_google_api_http_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x42, 0x89, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x42, 0x09, 0x48, 0x74, 0x74,
	0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x60, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x6f, 0x6b, 0x61, 0x7a, 0x31, 0x31, 0x31, 0x2f, 0x63, 0x61,
	0x6e, 0x64, 0x79, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x68, 0x65, 0x72, 0x74, 0x7a,
	0x5f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x67, 0x6f, 0x6c, 0x61,
